...
```sh
      $ git clone https://github.com/meamitverma/smart-traffic-management-system
```
  * Step II: Install the required packages
```sh
      # On the terminal, move into smart-traffic-management-system directory
...
Amit Verma - [meamitverma](https://github.com/meamitverma)
